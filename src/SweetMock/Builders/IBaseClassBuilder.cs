...
internal interface IBaseClassBuilder
{
    ...
    /// </summary>
    /// <param name="mockCode">The CodeBuilder instance to append the result to.</param>
...
internal interface IConfigExtensionBuilder
{
    public bool TryBuildConfigExtension(MockDetails details, CodeBuilder result, ISymbol[] symbols);
}

internal interface ILoggingExtensionBuilder
{
