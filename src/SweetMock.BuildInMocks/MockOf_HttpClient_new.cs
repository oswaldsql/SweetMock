...
#region Logging
        ...
        internal partial class MockConfig{
            internal MockConfig GetCallLogs(out HttpClient_Logs callLog){
                callLog = new HttpClient_Logs(target._sweetMockCallLog, target._sweetMockInstanceName);
                return this;
            }
        }
#endregion
...
#region Constructors
        ...
        ) : ArgumentBase(_containerName, "HttpClient", MethodSignature, InstanceName);
...
#region Method : Dispose
        ...
        ) : ArgumentBase(_containerName, "Dispose", MethodSignature, InstanceName);

        protected override void Dispose(bool disposing){
            this._log(new Dispose_Arguments(_sweetMockInstanceName, "Dispose(System.Boolean)", disposing : disposing));
            if (this._Dispose is null){
                throw new global::SweetMock.NotExplicitlyMockedException("Dispose", _sweetMockInstanceName);
            }
            this._Dispose.Invoke(disposing);
        }

        private MockConfig.DelegateFor_Dispose? _Dispose {get;set;} = disposing => {};
...
#region Method : Send
        ...
        ) : ArgumentBase(_containerName, "Send", MethodSignature, InstanceName);
        ...
        public override System.Net.Http.HttpResponseMessage Send(System.Net.Http.HttpRequestMessage request, System.Threading.CancellationToken cancellationToken){
            this._log(new Send_Arguments(_sweetMockInstanceName, "Send(System.Net.Http.HttpRequestMessage, System.Threading.CancellationToken)", request : request, cancellationToken : cancellationToken));
            if (this._SendAsync is null){
                throw new global::SweetMock.NotExplicitlyMockedException("Send", _sweetMockInstanceName);
            }
        ...
        internal partial class MockConfig{
            ...
            public MockConfig Send(System.Collections.Generic.IEnumerable<System.Net.Http.HttpResponseMessage> returnValues)
            {
                ...
                this.Send(call: (DelegateFor_Send)((System.Net.Http.HttpRequestMessage _, System.Threading.CancellationToken _) => {
                    ...
                    throw new SweetMock.NotExplicitlyMockedException("Send", "HttpClient");
                }
                ));
                return this;
            }
...
#region Method : SendAsync
        ...
        public override System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage> SendAsync(System.Net.Http.HttpRequestMessage request, System.Threading.CancellationToken cancellationToken){
            this._log(new SendAsync_Arguments(_sweetMockInstanceName, "SendAsync(System.Net.Http.HttpRequestMessage, System.Threading.CancellationToken)", request : request, cancellationToken : cancellationToken));
            if (this._SendAsync is null){
                throw new global::SweetMock.NotExplicitlyMockedException("SendAsync", _sweetMockInstanceName);
            }
...
internal class MockHandler : HttpMessageHandler
{
    ...
    internal partial class MockOf_HttpClient{
        internal class HttpClient_Logs(CallLog log, string? instanceName = null){
